...
describe('Tests if FavoritePokémons page works properly', () => {
  it('Displays \'No favorite pokemon found\' if none are favorited', () => {
  ...
  it('Displays all the favorited pokémon', () => {
    const mockFavorites = [
      {
        id: 4,
        name: 'Charmander',
    ...
    const MOCK_PMN_NUMBER = 3;

    const allFavorites = [charmander, rapidash, ekans];
    expect(allFavorites).toHaveLength(MOCK_PMN_NUMBER);
  });
});

...
export const FAVORITE_PAGE = 'Favorite Pokémons';
export const DETAILS_PAGE = 'More details';
...
export const NEXT_POKE = 'Próximo pokémon';
export const TYPE_BUTTON = 'pokemon-type-button';
